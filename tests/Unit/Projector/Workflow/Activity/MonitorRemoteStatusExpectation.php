...
class MonitorRemoteStatusExpectation
{
    ...
    public function expectsStopping(NotificationHub&MockInterface $hub, MonitorRemoteStatusStub $monitor): void
    {
        if ($monitor->onRise) {
    ...
    public function expectsResetting(NotificationHub&MockInterface $hub, MonitorRemoteStatusStub $monitor, bool $runInBackground): void
    {
    ...
    public function expectsDeleting(NotificationHub&MockInterface $hub, MonitorRemoteStatusStub $monitor, bool $withEmittedEvents): void
    {
