...
test('create projection with default table name', function (): void {
    $projectionProvider = new ConnectionProjectionProvider($this->connection, $this->clock);
...
test('create projection with custom table name', function (): void {
    $projectionProvider = new ConnectionProjectionProvider($this->connection, $this->clock, 'custom-table-name');
    $this->connection->expects('table')
