...
use Storm\Reporter\Filter\AllowAnyQuery;
...
it('deny', function (Message $message) {
    ...
    'event' => fn () => new Message(new SomeEvent(['foo' => 'bar'])),
    'query' => fn () => new Message(new SomeCommand(['foo' => 'bar'])),
]);
