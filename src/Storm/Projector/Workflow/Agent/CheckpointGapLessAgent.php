...
final class CheckpointGapLessAgent extends AbstractCheckpointAgent
{
    public function __construct(
        ...
        if ($checkpoints->recordGaps) {
            throw new LogicException('CheckpointGapLessWatcher cannot be used with record gaps enabled');
        }
